...
public class Usuariohist implements Serializable {
    ...
    @SequenceGenerator(name = "seguridad.seg_usuarioshist_tbl_seq", schema = "seguridad", sequenceName = "seguridad.seg_usuarioshist_tbl_seq", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seguridad.seg_usuarioshist_tbl_seq")
    @Getter
    @Setter
    ...
    public int hashCode() {
        int hash = 0;
        hash += (usIdUsuariohist != null ? usIdUsuariohist.hashCode() : 0);
        return hash;
    }
}
