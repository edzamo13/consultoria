...
public class Rolxusuario implements Serializable {
    ...
    @SequenceGenerator(name = "seguridad.seg_rolxusuario_tbl_seq", schema = "seguridad", sequenceName = "seguridad.seg_rolxusuario_tbl_seq", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seguridad.seg_rolxusuario_tbl_seq")
    @Getter
    @Setter
