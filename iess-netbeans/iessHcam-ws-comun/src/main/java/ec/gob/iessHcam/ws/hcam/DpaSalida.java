 ...
 */
public class DpaSalida implements Serializable {
    ...
    public DpaSalida(String estado, String grupo, String familia, String codProv, String codCan, String codParr, String desDpa) {
        this.estado = estado;
        this.grupo = grupo;
