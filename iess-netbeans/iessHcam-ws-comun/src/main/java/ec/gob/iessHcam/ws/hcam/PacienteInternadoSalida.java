 ...
 */
public class PacienteInternadoSalida implements Serializable {
    ...
    public PacienteInternadoSalida() {
        super();
    }

    public PacienteInternadoSalida(String unidadMedica, String fechaIngreso, String historiaClinica, String tipoDocumento, String cedula, String nombre, String codServicioOrigen, String dependenciaOrigen, String codServicioActual, String estadoInterno, String estado, String dependenciaActual) {
