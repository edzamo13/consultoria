...
/**
 * <b>
 *   Valor de respuesta para MISDTL. Se mantienen los nombres de los atributos con
 ...
 */
public class MISDTLRespuesta implements Serializable {

    private static final long serialVersionUID = -1422461130529850818L;
    ...
    @Getter
    @Setter
    private List<String> DLCEXAS = new ArrayList<String>(); // Código Exámen
    @Getter
    @Setter
