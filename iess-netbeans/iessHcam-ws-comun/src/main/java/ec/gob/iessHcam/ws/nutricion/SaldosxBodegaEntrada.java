...
public class SaldosxBodegaEntrada implements Serializable {
    ...
    public SaldosxBodegaEntrada() {
    }

    public SaldosxBodegaEntrada(String codUnmeAS400, String codDepAS400, String codBodegaAS400) {
