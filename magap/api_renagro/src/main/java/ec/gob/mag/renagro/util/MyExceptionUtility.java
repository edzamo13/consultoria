...
public class MyExceptionUtility {
	...
	public Boolean saveLog(ExceptionResponse ex, String urlServidor, String urlMicroLog, Consumer consumer) {
//		MyLog log = new MyLog(ex.getProyect(), ex.getClasse(), ex.getMessage(), ex.getNumberCode().getValue(),
//				ex.getType().getValue(), ex.getStack(), ex.getTimestamp());
//		ObjectMapper mapper = new ObjectMapper();
//		try {
//			@SuppressWarnings("unused")
//			Object responseUbicacion = consumer.doPost(urlServidor + urlMicroLog + "logs/create/",
