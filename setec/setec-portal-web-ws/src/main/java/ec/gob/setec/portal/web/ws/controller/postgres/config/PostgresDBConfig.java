package ec.gob.setec.portal.web.ws.controller.postgres.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "postgresEntityManagerFactory", transactionManagerRef = "postgresTransactionManager", basePackages = {
		"ec.gob.setec.portal.web.ws.controller.postgres.repository" })
...
public class PostgresDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("ec.gob.setec.portal.web.ws.controller.postgres.model")
