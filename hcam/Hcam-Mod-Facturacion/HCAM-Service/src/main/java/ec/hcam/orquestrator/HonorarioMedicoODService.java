...
public class HonorarioMedicoODService extends Basica implements HonorarioMedicoODServiceRemote {

    @Override
    @Asynchronous
    public Future obtenerRegistrosCE(int nivel, String iounme, Integer ioxdat, Integer unimedpk, Integer ubicapk) {

        System.out.println("Hora Inicio de Honorarios Medicos Odontologia:" + imprimirHora().toString());
        ...
        System.out.println("Hora Fin de Honorarios Medicos Odontologia:" + imprimirHora().toString());
    ...
    public void procesarDependenciasUnaAUna(int nivel, String iounme, int ioxdat, List<Dependencia> listaDependencia, List<CodigosConsultaExterna> listaHoraCodigo, Integer unimedpk, Integer ubicapk) {
        ...
        for (Dependencia dependencia : listaDependencia) {
            ...
            CodigosConsultaExterna odontologia = new CodigosConsultaExterna();
            for (CodigosConsultaExterna odonto : listaHoraCodigo) {
                if (odonto.getPADET2() == dependeciaObtenida) {
                    odontologia = odonto;
                }
            }
            ...
            procesarRegistrosDependencias(nivel, iounme, dependenciaObtenidaBi, ioxdat, listaHCTotalDependencia, odontologia);
            //if (i == 10) {
            //    break;
            //}
            i++;
    ...
    public void procesarRegistrosDependencias(int ctidpk, String ir2unm, BigInteger ir2dep, int ir2cit, List<InformacionCE> tasksT, CodigosConsultaExterna listaHoraCodigo) {
    ...
    public void aplicarRegla(InformacionCE objeto, String ir2unm, BigInteger ir2dep, int ir2cit, CodigosConsultaExterna listaHoraCodigo) {
        ...
        valor = listaHoraCodigo.getVALOR();
        descripcion = listaHoraCodigo.getDESCRIPCION();
        pacotar = listaHoraCodigo.getPACODTAR();
