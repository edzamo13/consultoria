...
public class EquiposEspecialesHospitalizacionService extends Basica implements EquiposEspecialesHospitalizacionRemote {
    ...
    public Future obtenerEquiposEspeciales(String unidMedica, Integer fecha, Integer nivel, Integer unidpk, Integer ubicapk) {
        ...
        System.out.println("Hora Inicio Equipos Especiales Hospitalizacion:" + imprimirHora().toString());
        ...
        System.out.println("Hora Fin Equipos Especiales Hospitalizacion:" + imprimirHora().toString());
    ...
    private void registrarDetallePlanillaje(double historiaClinica, String uniMed, String iofeor) {
        ...
        for (EquiposEspeciales equipo : lstEquipos) {
            ...
            entidadDetalle.setDepRea("Hospitalizacion");
            ...
            entidadDetalle.setCoditem(String.valueOf(equipo.getCodigoEquipo()));
