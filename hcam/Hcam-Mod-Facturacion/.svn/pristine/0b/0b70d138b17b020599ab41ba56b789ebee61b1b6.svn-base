...
@Remote
public interface GasesMedicinalesRemote {
    
    Future obtenerRegistrosGasesMedicinales(String unidMedica, Integer fecha1,Integer nivel,Integer unidpk,Integer ubicapk);
