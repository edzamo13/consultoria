 ...
 */
@Entity
@Table(name = "CABTARITBL", catalog = "S101719R", schema = "FACWEB")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Cabtaritbl.findByTanivelum", query = "SELECT c FROM Cabtaritbl c WHERE c.tanivelum = :tanivelum")})
public class Cabtaritbl implements Serializable {
    ...
    private int tanivelum;
    @OneToMany(mappedBy = "ctidpk")
    private List<Tarifaftbl> tarifaftblList;
    ...
    public Cabtaritbl(Integer ctidpk, int tanivelum) {
        this.ctidpk = ctidpk;
    ...
    public int getTanivelum() {
        return tanivelum;
    }

    public void setTanivelum(int tanivelum) {
        this.tanivelum = tanivelum;
    }

    @XmlTransient
    public List<Tarifaftbl> getTarifaftblList() {
        return tarifaftblList;
    }

    public void setTarifaftblList(List<Tarifaftbl> tarifaftblList) {
        this.tarifaftblList = tarifaftblList;
    }
    ...
    public String toString() {
        return "ec.hcam.entities.Cabtaritbl[ ctidpk=" + ctidpk + " ]";
    }
