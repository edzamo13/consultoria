...
@Remote
public interface EquiposEspecialesHospitalizacionRemote {

    Future obtenerEquiposEspeciales(String unidMedica, Integer fecha, Integer nivel,Integer unidpk,Integer ubicapk);
