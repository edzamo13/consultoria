 ...
 * @author Programacion
 */
public class ProcedimientosRehabilitacionServiceUnitTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Future future = procedimientosRehabilitacion.obtenerRegistrosProcedimientoRehabilitacion("1110100000", 20150429, 1, 1, 1);
