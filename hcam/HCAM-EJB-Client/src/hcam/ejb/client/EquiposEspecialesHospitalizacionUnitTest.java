 ...
 * @author pestupinan
 */
public class EquiposEspecialesHospitalizacionUnitTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Future future = equiposEspecialesHospitalizacion.obtenerEquiposEspeciales("1110100000", 20150429, 1, 1, 1);
