 ...
 * @author programacion
 */
public class ServiciosInstitucionalesServiceUnitTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Future future = serviciosInstitucionales.obtenerRegistrosServiciosInstitucionales("1110100000", 20150429, 1, 1, 1);
